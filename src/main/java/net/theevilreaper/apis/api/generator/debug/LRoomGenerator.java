...
public final class LRoomGenerator extends AbstractDebugGenerator {

    public LRoomGenerator(Path filePath, RoomSchematicLoader roomSchematicLoader) {
        super("LGen", filePath, roomSchematicLoader);
